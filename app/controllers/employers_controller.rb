class EmployersController < ApplicationController
  ...
  # GET /employers.json
  def index
    @employers = Employer.paginate(:page => params[:page], :per_page => 4)
  end
  ...
  private
    ...
    def employer_params
      params.require(:employer).permit(:name, :address, :city, :state, :zip_code, :website, :email, :phone_no, :alternative_no)
    end
end
